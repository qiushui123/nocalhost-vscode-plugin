  ...
  return (
    <div>
      <div className="type">
        <BottomNavigation
          value={isLocal}
          onChange={(event: React.ChangeEvent<{}>, newValue: string) => setIsLocal(newValue)}
          showLabels
          classes={{
        ...
        >
          ...
          <BottomNavigationAction label="Connect to Nocalhost Server" value={"0"} />
        </BottomNavigation>
      </div>
      {isLocal === "0" && (
      ...
      {isLocal === "1" && (
        <div className="type">
          ...
          >
            <Tab label="Select Kubeconfig file" value="1" classes={{root:classes.kubeconfigToggle}} />
            <Tab label="Paste as text" value="0" classes={{root:classes.kubeconfigToggle}} />
          </Tabs>
